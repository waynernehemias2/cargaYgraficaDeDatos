...
public class reportegenero {
    ...
    public static void reporte(){
        try {
            PrintWriter reporteA = new PrintWriter("reporteGeneros.html", "UTF-8");
            reporteA.println("<!DOCTYPE html>");
            reporteA.println("<head>");
            reporteA.println("<title>Estadistica de genero en el curso </title> ");
            reporteA.println("<link href=\"estilo.css\" rel=\"stylesheet\" type=\"text/css\">");
            reporteA.println("</head>");
            reporteA.println("<body>");
            reporteA.println("<h1> Estadistica de genero en el curso "+graficar.vari+" </h1>");
         ...
         reporteA.println("<p>Grafica de curso "+graficar.vari+"</p>\n" +
                                "<center><img src=\"Grafica de generos.jpeg\"></center>");
